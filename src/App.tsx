      ...
      <main className="app-main">
        ...
        <section className="hero-section">
          <div className="hero-content">
            ...
            <h1>Atención médica digital para los ciudadanos de <span className="hero-highlight">La Paz</span></h1>
            <p>Conéctate con profesionales de la salud desde cualquier lugar, de forma segura y eficiente</p>
          </div>
        </section>
